...
public class DateAndTimeExamples {
    public static void main(String[] args) {
        ...
        //Increased localTime2 by 15 minutes
        localTime2 = localTime2.plusMinutes(15);
        System.out.println("Break until: " +localTime2);
        ...
        System.out.println(Duration.between(firstInternationCatsDay,LocalDateTime.now()).toMinutes());
